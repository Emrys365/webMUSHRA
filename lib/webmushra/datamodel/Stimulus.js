...
Stimulus.prototype.getOrigAudioBuffer = function() {
  return this.origAudioBuffer;
};

Stimulus.prototype.setOrigAudioBuffer = function(_audioBuffer) {
  this.origAudioBuffer = _audioBuffer;
};
