...
function MultiMetricMushraAudioControlInputController(_mushraAudioControl, _looping){
    this.mushraAudioControl = _mushraAudioControl;
    this.looping = _looping;
}


MultiMetricMushraAudioControlInputController.prototype.bind = function(){
    ...
    (function(i) {
        ...
        Mousetrap.bind(['up', 'j', 'shift+up', 'shift+j'], function(e, combo) {
                                                ...
                                                for(j = 0; j < conditions.length; ++j){
                                                  var slider = $('.scales').get(j * offset + idx);
...
MultiMetricMushraAudioControlInputController.prototype.unbind = function(){
